...
>(({ className, children, error, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full cursor-pointer items-center justify-between rounded-md border bg-background px-3 py-2',
...
export interface SelectProps {
  /** Flat options, or grouped via `{ group, items }`. */
...
const isGroup = (o: Option | OptionGroup): o is OptionGroup =>
  (o as OptionGroup).group !== undefined
